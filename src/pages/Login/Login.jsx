...
const Login = () => {
	...
	<p className="text-sm text-center dark:text-gray-400">Dont have account?
		<Link to={'/register'}>
        <span className="focus:underline hover:underline text-blue-600">Sign up here</span>
        </Link>
	</p>
	...
	<form onSubmit={handleSubmit} noValidate="" action="" className="space-y-8">
		<div className="space-y-4">
			<div className="space-y-2">
				...
				<input type="email" name="email" id="email" placeholder="Your Email" className="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
			</div>
			<div className="space-y-2">
